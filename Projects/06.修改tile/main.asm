...
;main.c:7: UINT8 currentspriteindex = 0 ; 
	ld	c, #0x00
;main.c:8: set_sprite_data ( 0, 4, c01);
	ld	hl, #_c01
	push	hl
	ld	a, #0x04
	push	af
...
;main.c:12: SHOW_SPRITES;
	...
	or	a, #0x02
	ldh	(_LCDC_REG+0),a
;main.c:13: set_bkg_data(0,16,backgroundtile);
	ld	hl, #_backgroundtile
	push	hl
	ld	a, #0x10
	push	af
	...
	call	_set_bkg_data
	add	sp, #4
;main.c:14: set_bkg_tiles(0,0,MAP1Width,MAP1Height,MAP1);
	ld	hl, #_MAP1
	push	hl
	ld	de, #0x1220
	push	de
...
00104$:
;main.c:33: if (currentspriteindex == 0)
	ld	a, c
	or	a, a
	jr	NZ, 00106$
;main.c:35: currentspriteindex = 1;
	ld	c, #0x01
00106$:
;c:/gbdk/include/gb/gb.h:1234: OAM_item_t * itm = &shadow_OAM[nb];
	ld	de, #_shadow_OAM
